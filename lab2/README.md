...
*   **Аппаратная архитектура и среда:** Замеры производительности проводились на виртуальной машине **Virtual Box** с гостевой ОС **Ubuntu 24 (x86_64)**, запущенной на хостовой системе **Windows 10 (x86_64)**. Виртуальной машине было выделено **8 процессорных ядер**.
...
*   **Оборудование/Среда**: Запускал на виртуальной машине VMware Workstation с ubuntu 24 (x86_64) (основаная операционная система windows 11 (тоже x86_64)). Виртуальной машине было выделено **8 процессорных ядер**.
